...
const ChatBox = styled(Box)`
  height: 300px; /* Adjust the height of the chat box */
  width: 100%;
  overflow-y: auto;
  background: #2c2c2c;
...
export default function Chat() {
  ...
  useEffect(() => {
    console.log(chatMessages)  // Check if chatMessages is populated
    scrollToBottom()
          ...
          <>
            ...
            <ChatBox>
              {chatMessages.length > 0 ? (
                ...
                <p>No messages yet.</p>  // Fallback text if there are no messages
              )}
